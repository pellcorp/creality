...

{
    ...
    if [ -f /usr/data/pellcorp-backups/printer.factory.cfg ]; then
        ...
        # config overrides not supported for useful macros so no point backing up
        if [ -f /usr/data/pellcorp-backups/useful_macros.cfg ]; then
          rm /usr/data/pellcorp-backups/useful_macros.cfg
        fi
